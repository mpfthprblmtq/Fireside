...
public class Bedroom {
    ...
    // ivars
    private String bedroom_comments;
     ...
     */
    public void setWallsceiling_type(String wallsceiling_waterdamage) {
        this.setWallsceiling_waterdamage(wallsceiling_waterdamage);
    }
    ...
    /**
     * @return the bedroom_comments
     */
    public String getBedroom_comments() {
        return bedroom_comments;
    }

    /**
     * @param bedroom_comments the bedroom_comments to set
     */
    public void setBedroom_comments(String bedroom_comments) {
        this.bedroom_comments = bedroom_comments;
    }
